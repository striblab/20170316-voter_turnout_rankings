# Star Tribune - National voter turnout rankings
...
1. Get code and enter project: `git clone https://github.com/striblab/20170316-voter_turnout_rankings.git && cd 20170316-voter_turnout_rankings.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170316-voter_turnout_rankings/ && rsync -rav ./ ../20170316-voter_turnout_rankings/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
